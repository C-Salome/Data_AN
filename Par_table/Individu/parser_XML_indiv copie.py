...
lig = []
col = ["id_indiv","nom", "prenom", "genre", "date_naissance", "dep_naissance", "date_deces", "parlementaire"]
...
#print(out_df)
out_df.to_csv(r'/Users/salomecolza/desktop/These_Hugo/AMO30_indiv_v1.csv', index = False, header=True)
